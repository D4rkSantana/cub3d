...
/*   Updated: 2023/04/09 20:22:17 by esilva-s         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	horizontal_intersection(t_data *data, t_ray *ray)
{
	...
	else if (ray->is_facing_up)
	{
		...
		intercep_x = data->player->pos_x + (data->player->pos_y - intercep_y) / tan(ray->ray_angle);
...
void	vertical_intersection(t_data *data, t_ray *ray)
{
	...
	intercep_y = data->player->pos_y + (data->player->pos_x - intercep_x) * tan(ray->ray_angle);
